...
<html lang="en">
  ...
  <body>
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                              <h2 class="card-header-title">Supplier Table</h2>
                                    ...
                                    <table id='table-data' class="stripe row-border order-column" style="width:100%">
                                      <thead>
                                          <tr>
                                            ...
                                            <th class="border-0 text-center">공급처명</th>
                                            <th class="border-0 text-center">주소</th>
                                            <th class="border-0 text-center">전화번호</th>
                                            <th class="border-0 text-center">공급구분</th>
                                          </tr>
                                      </thead>
                                    </table>
                                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                              <h3 class="card-header-title mb-0">Supplier Count By Center</h3>
                            </div>
                            <div class="card-body">
                              <div id="supplier-chart" style="height: 230px;"></div>
                            </div>
                        </div>
                    </div>
                  </div> -->
      ...
      <script src="/beans/assets/libs/js/supplier/get-supplier.js"></script>
