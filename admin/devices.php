<?php
    ...
    $result = mysqli_query($conn, "SELECT * FROM voc_devices ORDER BY flag DESC, regiDate DESC");
    mysqli_close($conn);
 ?>
<!doctype html>
<html lang="en">
                  ...
                  <div class="container-fluid dashboard-content">
                      ...
                      <div class="row">
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="page-header">
                                  <h2 class="pageheader-title">Device List</h2>
                                  <div class="page-breadcrumb">
                                      ...
                                      <div class="float-left" style="margin-bottom:5px">
                                          <button class="btn btn-info" onClick="moveDeviceAd()">Add Device</button>
                                      </div>
                                      <div class="float-right" style="margin-bottom:5px">
                                          <button class='btn btn-secondary' onclick='removeDeviceData()'>Delete</a>
                                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                              <div class="card">
                                  <div class="card-body">
                                        <input class="form-control form-control-lg" type="search" placeholder="Model Name" aria-label="Search" onkeypress="if(event.keyCode==13){searchDevice(); return false;}">
                                            ...
                                            <div class='card-body'>
                                                <div class='row align-items-center'>
                                                    <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'>
                                                            ...
                                                            <div class='pl-xl-3'>
                                                                <div class='m-b-0'>
                                                                    <div class='user-avatar-name d-inline-block'>
                                                                        <h2 id='model_id".$i."' class='font-24 m-b-10'>".$row['model']."</h2>
                                                                    </div>
                                                                    <div class='rating-star d-inline-block pl-xl-2 mb-2 mb-xl-0'>
                                                                        <p class='d-inline-block text-dark'>ManuFacturer : ".$row['manu']."</p>
                                                                    </div>
                                                                    <div class='rating-star d-inline-block pl-xl-2 mb-2 mb-xl-0'>
                                                                        <p class='d-inline-block text-dark'>Pet Name : ".$row['petName']."</p>
                                                                    </div>
                                                                </div>
                                                                <div class='user-avatar-address'>
                                                                    <p class='mb-2'><i class='fas fa-mobile-alt mr-2  text-primary'></i>
                                                                    <span class='m-l-10'>".$row['os']."<span class='m-l-10'>".$row['osVer']."<span class='m-l-20'>출시일: ".$row['launDate']."</span></span></span>
                                                                    </p>
                                                                    <p class='mb-2'><i class='fas fa-info mr-2  text-primary'></i>
                                                                    <span class='m-l-10'>SW ver: ".$row['swVer']."<span class='m-l-10'>Type: ".$row['class']."<span class='m-l-10'>차수: ".$row['roundNo']."<span class='m-l-20'>배포일: ".$row['deployDate']."<span class='m-l-20'>등록일: ".$row['regiDate']."</span></span></span></span></span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class='col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'>
                                                            <div class='float-left' style='margin-bottom:5px'>
                                                                <button class='btn check' onclick='setfocus(".$row['id'].",".$row['flag'].")' checked='".$row['flag']."'>Deploy</button>
                                                            </div>
