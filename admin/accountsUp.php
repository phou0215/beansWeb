<?php
    ...
    $sql = "SELECT * FROM user WHERE id=".trim($_GET['id']);
                                    ...
                                    <div class="page-breadcrumb">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="/voc/admin/accounts.php" class="breadcrumb-link">User List</a></li>
                        ...
                        <div class="page-section" id="overview">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="padding-left:7px;padding-right:7px;">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="regiDeviceForm" data-parsley-validate="" novalidate="" action="/voc/admin/phpdata/updateUserData.php?" method="post" onsubmit='return userInfoCheck();'>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">ID*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input id="id" type="text" class="form-control" name="id" hidden value="<?php echo $id;?>">
                                                    <input id="ident" type="text" class="form-control" name="ident" value="<?php echo $row['ident'];?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Auth*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                  <select id="auth" name="auth" style="width:100px;height:35px;">
                                                    <?php
                                                      $index = ['0','1'];
                                                      $names = ['No Deploy','Deploy'];
                                                      for($i=0; $i<count($index); $i++){
                                                        if($index[$i] == (string) $row['auth']){
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input id="phoneNum" type="text" class="form-control" name="phoneNum" value="<?php echo $row['phoneNum'];?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Admin Auth*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                  <select id="adminAuth" name="adminAuth" style="width:100px;height:35px;">
                                                    <?php
                                                      $index = ['0','1'];
                                                      $names = ['No Deploy','Deploy'];
                                                      for($i=0; $i<count($index); $i++){
                                                        if($index[$i] == (string) $row['adminAuth']){
                                                          echo'<option value="'.$index[$i].'" selected="selected">'.$names[$i].'</option>';
                                                        }else{
                                                          echo'<option value="'.$index[$i].'">'.$names[$i].'</option>';
                                                        }
                                            ...
                                            <div class="form-group row text-right">
                                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                    ...
                                                    <button type="button" class="btn btn-space btn-secondary" onclick="window.location='/voc/admin/accounts.php';">Cancel</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
