                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Add Device</h2>
                                    ...
                                    <div class="card-body">
                                        <form id="regiDeviceForm" data-parsley-validate="" novalidate="" action="/voc/admin/phpdata/addDeviceData.php" method="post" onsubmit='return infoCheck();'>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" required="" name="petName" placeholder="Pet Name" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Launch Date*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input id="launch_date" type="date" name="launDate" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Software Version*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="swVer" placeholder="SW Version" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input id="launch_date" type="date" name="deployDate" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">OS Version*</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="osVer" placeholder="OS Version" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Round</label>
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <input type="text" name="roundNo" placeholder="Round Only number" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    <textarea id="extra" name="extra" placeholder="Description" rows="5" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row text-right">
                                                <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                    <button type="submit" class="btn btn-space btn-primary">Add Device</button>
